...
const Google : React.FC<iconProps> = ({w , h }) => {
    console.log(`${h}px`)
    return (
        <svg  width={`${w}px`}   height={`${h}px`} viewBox="0 0 256 262" version="1.1" xmlns="http://www.w3.org/2000/svg"  preserveAspectRatio="xMidYMid">
            <g>
